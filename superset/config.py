...
# ---------------------------------------------------------
# Superset specific config - Changed to Urbandatalab.fr Custom Config by Chris
# ---------------------------------------------------------
...
#     "rel": "icon"
# },
FAVICONS = [{"href": "/static/assets/images/urbandatalabfr_custom_assets/Urbandatalabfr_favicon.png"}]
...
# ------------------------------
# GLOBALS FOR APP Builder - Custom changed to Urbandatalab.fr branding by Chris
# ------------------------------
# Uncomment to setup Your App name
APP_NAME = "Urbandatalab.fr"

# Specify the App icon
APP_ICON = "/static/assets/images/urbandatalabfr_custom_assets/Urbandatalabfr_logo.png" 

# Specify where clicking the logo would take the user
# e.g. setting it to '/' would take the user to '/superset/welcome/'
LOGO_TARGET_PATH = 'https://www.urbandatalab.fr/'

# Specify tooltip that should appear when hovering over the App Icon/Logo
LOGO_TOOLTIP = "Urbandatalab.fr"
...
# ---------------------------------------------------
# Babel config for translations - Changed to French for Urbandatalab.fr by Chris
# ---------------------------------------------------
