...
`},62948:(e,t,r)=>{r.d(t,{E5:()=>w,G:()=>g,Ks:()=>$,Mv:()=>p,OD:()=>f,Su:()=>b,aQ:()=>Z,gH:()=>k,gt:()=>y,kq:()=>x,nn:()=>c,oA:()=>u,oo:()=>m,xZ:()=>h,yk:()=>v,zV:()=>d});var l=r(51995),a=r(11965),i=r(74069),n=r(35932),o=r(87183),s=r(9433);const u=(0,l.iK)(i.default)`
  .ant-modal-body {
    padding: 0;
  }
`,d=l.iK.div`
...
`},6065:(e,t,r)=>{r.r(t),r.d(t,{default:()=>_});var l=r(51995),a=r(61988),i=r(31069),n=r(67294),o=r(19259),s=r(70707),u=r(93139),d=r(14114),c=r(58593),p=r(86074),m=r(15926),h=r.n(m),g=r(34858),y=r(11965),f=r(74069),b=r(81315),v=r(84101),x=r(49238),Z=r(62948),$=r(8272);const w=[{label:(0,a.t)("Regular"),value:"Regular"},{label:(0,a.t)("Base"),value:"Base"}];var k;!function(e){e.REGULAR="Regular",e.BASE="Base"}(k||(k={}));const U=(0,l.iK)(f.default)`
  max-width: 1200px;
